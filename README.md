...
1. **Download**: Get the latest `Burpcord-2.7.0.jar` from the [Releases](https://github.com/jondmarien/burpcord/releases) page.
...
Burpcord v2.7.0 uses the **ShadowJar** plugin to bundle dependencies and prevent runtime conflicts with Burp Suite.
